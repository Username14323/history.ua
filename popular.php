...
<html>
    ...
    <link rel="stylesheet" type="text/css" href="/cssfiles/popular.css">
    ...
    <h1 style=font-size:60px;><?php echo $config ['title']; ?></h1>
      ...
      <div class="ser">
        ...
        <div class="titleHistory">
          <h1>Популярні історії</h1>
        </div>

        <hr>

        <div class="pn">
          <p><span><a href="new.php" class="pop_new" style="color:white; text-align:center;">Нові</a></span></p>
        </div>
        ...
        <div class="block-history">
            <?php 
        $history_p = mysqli_query($connection, "SELECT * FROM `articles` ORDER BY `views` DESC");
        ?>

        <?php
        while( $art = mysqli_fetch_assoc($history_p) )
        {
        ?>
