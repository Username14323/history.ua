...
<div class="container">
    ...
    <?php if (!empty($_SESSION['login'])): ?>
        ...
        <form action="/admin/news/create_process.php" method="POST" enctype="multipart/form-data">
            <input type="text" name="name" placeholder="Назва новини" required>
            <textarea name="text" placeholder="Текст новини" required></textarea>
            <h4>Фото</h4>
