...
?>
 <?php 
    ...
    if (!empty($_POST['search'])) {
        ...
        $stmt = $pdo->prepare("SELECT * FROM `news` WHERE `name` LIKE :search");
        ...
        <?php foreach ($results as $result): ?>
            <li class="news-item">
                ...
                <div class="form-container">
                    ...
                    <form action="/admin/news/news.php/<?php echo $result['id'] ?>" method="POST" enctype="multipart/form-data">
                        <?php echo $result['id'] ?>
                        <hr>
                        ...
                        <h4>Додати відео</h4>
                        <input type="file" name="video" value="<?php echo $result['video'] ?>">
                ...
                <?php if (!empty($result['image']) && !empty($result['video'])): ?>
                    <div class="media-container">
                        ...
                        <div class="video">
                            <video width="560" height="315" controls>
                                <source src="news/videos/<?php echo $result['video'] ?>" type="video/mp4">
